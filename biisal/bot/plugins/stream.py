...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"https://ddlinkstg.blogspot.com/p/stream.html?link={str(log_msg.id)}"
        online_link = f"https://ddlinkstg.blogspot.com/p/download.html?link={str(log_msg.id)}"
