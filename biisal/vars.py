...
class Var(object):
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'BIND_ADRESS:PORT')) if not ON_HEROKU or getenv('FQDN', 'vps.hostingup.icu:9097') else APP_NAME+'.herokuapp.com'
    ...
    DB_URI = str(getenv('DB_URI', 'mongodb+srv://kailash:pass@cluster0.sqtztxm.mongodb.net/?retryWrites=true&w=majority'))
    DB_NAME = str(getenv("DB_NAME", "kumhh"))
