...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://yewilis933:SGROmrioybQJAnWj@cluster0.96en1.mongodb.net/myDatabase?retryWrites=true&w=majority&appName=Cluster0'))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'Cluster0')) 
    ...
    DB_URI = str(getenv('DB_URI', 'mongodb+srv://yewilis933:SGROmrioybQJAnWj@cluster0.96en1.mongodb.net/myDatabase?retryWrites=true&w=majority&appName=Cluster0'))
    DB_NAME = str(getenv("DB_NAME", "Vansh"))
    SECOND_BOTUSERNAME = str(getenv("SECOND_BOTUSERNAME", "movie_hub09_bot"))
    FILE_BOT_TOKEN = str(getenv('FILE_BOT_TOKEN', '6932919860:AAECwfGbxyS6b1fSFFinD_h0czZwp_Te84E'))
